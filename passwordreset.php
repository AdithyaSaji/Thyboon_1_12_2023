...
if(isset($_REQUEST['pwdrst']))
{
  ...
  if($pwd == $cpwd)
  {
    $reset_pwd = mysqli_query($connection,"update  forforgot_pass set PASSWORD='$pwd' where EMAIL='$email'");
    if($reset_pwd>0)
    {
...
if($_GET['secret'])
{
  ...
  $check_details = mysqli_query($connection,"select email from  forforgot_pass where EMAIL='$email'");
